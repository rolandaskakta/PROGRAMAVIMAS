...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Ls); // iseksportuojam
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Ls_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Ls.js */ "./Ls.js");
...
var init = function init(_) {
  LS = new _Ls_js__WEBPACK_IMPORTED_MODULE_0__["default"]('Ganykla');
  _render(LS.list);
  var createType = document.querySelector('[data-create-type]');
  var createWeight = document.querySelector('[data-create-weight]');
  var createButton = document.querySelector('[data-create-button]');
  createButton.addEventListener('click', function (_) {
    var type = createType.value;
    var weight = Number(createWeight.value);
    var gyvunai = {
      type: type,
      weight: weight
    };
...
var _render = function render(list) {
  var listBin = document.querySelector('[data-animals-list]');
  var template = document.querySelector('[data-list-template]');
  listBin.innerHTML = '';
  list.forEach(function (animal) {
    var rowHtml = template.content.cloneNode(true);
    var typeEl = rowHtml.querySelector('[data-animal-type]');
    var editInput = rowHtml.querySelector('[data-edit-weight]');
    var editButton = rowHtml.querySelector('[data-edit-button]');
    var deleteButton = rowHtml.querySelector('[data-delete-button]');
    ...
    editButton.addEventListener('click', function (e) {
      var id = e.target.dataset.id;
      var weight = Number(editInput.value);
      var svoris = {
        weight: weight
      };
      LS.Update(id, svoris);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcrud"] = self["webpackChunkcrud"] || [];
